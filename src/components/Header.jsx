...
import quastionIcon from '../assets/img/quastion_icon.png';
    ...
    <header className="header">
      <div className="header__container">
        ...
        <div className="header__actions">
          <Button className="button--random-series">
            <img src={quastionIcon} alt="" />
            <span>Random Series</span>
          </Button>
          <Link to="/favorites">
            <Button className="button button--favorites">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
